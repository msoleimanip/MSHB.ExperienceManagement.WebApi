...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSHB.ExperienceManagement.Layers.L01_Entities.Models.EquipmentAttachment", b =>
                {
                    ...
                    b.HasIndex("EquipmentId", "EquipmentAttachmentName", "EquipmentAttachmentType");

                    b.ToTable("EquipmentAttachment_T");
                });

            modelBuilder.Entity("MSHB.ExperienceManagement.Layers.L01_Entities.Models.EquipmentAttachmentIssueDetailSubscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<long>("EquipmentAttachmentId");

                    b.Property<long>("IssueDetailId");

                    b.HasKey("Id");

                    b.HasIndex("EquipmentAttachmentId");

                    b.HasIndex("IssueDetailId");

                    b.ToTable("EquipmentAttachmentIssueDetailSubscription_T");
                });
            ...
            modelBuilder.Entity("MSHB.ExperienceManagement.Layers.L01_Entities.Models.IssueDetailLike", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MSHB.ExperienceManagement.Layers.L01_Entities.Models.EquipmentAttachmentIssueDetailSubscription", b =>
                {
                    b.HasOne("MSHB.ExperienceManagement.Layers.L01_Entities.Models.EquipmentAttachment", "EquipmentAttachment")
                        .WithMany("EquipmentAttachmentIssueDetailSubscriptions")
                        .HasForeignKey("EquipmentAttachmentId");

                    b.HasOne("MSHB.ExperienceManagement.Layers.L01_Entities.Models.IssueDetail", "IssueDetail")
                        .WithMany("EquipmentAttachmentIssueDetailSubscriptions")
