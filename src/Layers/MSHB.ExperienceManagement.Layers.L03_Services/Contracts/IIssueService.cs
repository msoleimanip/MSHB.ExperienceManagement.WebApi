...
namespace MSHB.ExperienceManagement.Layers.L03_Services.Contracts
{
    public interface IIssueService
    {
        ...
        Task<SearchIssueDetailsViewModel> GetIssueDetailsAsync(User user, SearchIssueDetailFormModel searchIssueDetailForm);
        ...
        Task<bool> DeleteIssueAsync(User user, DeleteIssueFormModel deleteIssueFormModel);
    }
}
